...
def compute_temperature_particle(temp_particle, constant, dt, conductivity, laplacian, density, alpha, moisture,
                                 relative_humidity, N, heat_of_vaporization, heat_transfer_coefficient,
                                 specific_surface,
                                 temp_gas, heat_capacity):
...
def compute_temperature_gas(temp_particle, constant, dt, conductivity_gas, laplacian, density_gas, alpha, moisture, N,
                            heat_capacity_vapor, relative_humidity, heat_transfer_coefficient, specific_surface,
                            temp_gas, heat_capacity_wet_gas, velocity, temp_gradient, porosity, density_particle):
...
def compute_molar_concentration(relative_humidity, pressure_saturated, R, temperature):
    molar_concentration = 0.01 * relative_humidity * pressure_saturated / (R * temperature)

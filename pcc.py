...
class Ui_pcc(object):
    def setupUi(self, pcc):
        ...
        self.n_height_steps = QtWidgets.QLineEdit(pcc)
        self.n_height_steps.setObjectName("n_height_steps")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.n_height_steps)
        ...
        self.label_4 = QtWidgets.QLabel(pcc)
        self.label_4.setObjectName("label_4")
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_4)
        self.temp_kelvin = QtWidgets.QLineEdit(pcc)
        self.temp_kelvin.setObjectName("temp_kelvin")
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.temp_kelvin)
        ...
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.antoine_constants_A)
        ...
        self.formLayout_2.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.antoine_constant_B)
        ...
        self.formLayout_2.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.antoine_constant_C)
        ...
        pcc.setTabOrder(self.n_space_steps, self.n_height_steps)
        pcc.setTabOrder(self.n_height_steps, self.resolution)
        pcc.setTabOrder(self.resolution, self.R_gas_constant)
        pcc.setTabOrder(self.R_gas_constant, self.temp_kelvin)
        pcc.setTabOrder(self.temp_kelvin, self.antoine_constants_A)
    ...
    def retranslateUi(self, pcc):
        ...
        self.temp_init.setText(_translate("pcc", "253.426"))
        self.label_34.setText(_translate("pcc", "Temperature walls (K):"))
        self.temp_walls.setText(_translate("pcc", "252.426"))
        ...
        self.boiling_temperature.setText(_translate("pcc", "333.426"))
        self.label.setText(_translate("pcc", "Discretization parameters:"))
        self.label_37.setText(_translate("pcc", "Maximal time (sec):"))
        ...
        self.label_39.setText(_translate("pcc", "Steps in height:"))
        self.n_height_steps.setText(_translate("pcc", "7"))
        ...
        self.label_4.setText(_translate("pcc", "Temperature (Kelvin):"))
        self.temp_kelvin.setText(_translate("pcc", "233.426"))
